  ...
  <div class="col-xl-8 col-md-7">
    <div class="row">
      <div class="col-sm-5 col-12 d-md-none grid-margin">
        <div class="card">
          <div class="card-body">
            <h2 class="card-title icon-sm">Yahh, Menunya Habis</h2>
            <hr>
            <ul>
              <?php
      ...
      <div class="col-md-12 col-sm-7 order-first grid-margin">
        <div class="card">
          <div class="card-body">
            <h2 class="card-title icon-sm">Pesan, dan dipilih dulu kak</h2>
            <hr>
            <form method="post">
              <div class="row">
                <div class="col-sm-8">
      ...
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <h2 class="card-title icon-sm">Pesanan yang sudah dipilih tadi</h2>
                <hr>
      ...
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            ...
            ?>
            <h2 class="card-title icon-sm">Transaksi dan Bayar ya!</h2>
            <hr>
